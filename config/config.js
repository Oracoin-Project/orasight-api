...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.orasight');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Oracoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Oracoin/';
  if (isLinux) dataDir = process.env.HOME + '/.Oracoin/';
}
