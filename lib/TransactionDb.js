...
var genesisTXID = 'bd8140b7001304a143586a1e6dbb6d4e96b71697a2e01a463088e3e3846bca6a';
var CONCURRENCY = 10;
...
var encodedData = require('soop').load('oracore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('oracore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('oracore/lib/Address', {
